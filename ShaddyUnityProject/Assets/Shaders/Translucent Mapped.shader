...
/*SF_DATA;ver:1.40;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,cpap:True,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:True,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:32415,y:32724,varname:node_4013,prsc:2|diff-8856-RGB,normal-8523-RGB,transm-7497-OUT,amdfl-7873-OUT;n:type:ShaderForge.SFN_Tex2d,id:8856,x:32171,y:32598,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:_Diffuse,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:d58222ea217c9b24193b43b931336cec,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:8523,x:32171,y:32775,ptovrint:False,ptlb:Normal,ptin:_Normal,varname:_Normal,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:fb2f3f1daa44f604496abcd632c96883,ntxv:3,isnm:True;n:type:ShaderForge.SFN_LightVector,id:1968,x:31589,y:32852,varname:node_1968,prsc:2;n:type:ShaderForge.SFN_NormalVector,id:8748,x:31589,y:32975,prsc:2,pt:False;n:type:ShaderForge.SFN_Dot,id:9030,x:31809,y:32852,varname:node_9030,prsc:2,dt:4|A-1968-OUT,B-8748-OUT;n:type:ShaderForge.SFN_OneMinus,id:3638,x:31974,y:32852,varname:node_3638,prsc:2|IN-9030-OUT;n:type:ShaderForge.SFN_Multiply,id:7497,x:32171,y:32942,varname:node_7497,prsc:2|A-3638-OUT,B-6272-OUT;n:type:ShaderForge.SFN_LightColor,id:5405,x:31974,y:33083,varname:node_5405,prsc:2;n:type:ShaderForge.SFN_Multiply,id:7873,x:32171,y:33070,varname:node_7873,prsc:2|A-5405-RGB,B-5405-A,C-3582-OUT;n:type:ShaderForge.SFN_Slider,id:3582,x:31817,y:33225,ptovrint:False,ptlb:ambientBase,ptin:_ambientBase,varname:node_3582,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Slider,id:6272,x:31817,y:33020,ptovrint:False,ptlb:transmission,ptin:_transmission,varname:node_6272,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;proporder:8856-8523-6272-3582;pass:END;sub:END;*/

Shader "RealChute2/Translucent Mapped" {
    Properties {
